...
public interface DocumentRepository extends JpaRepository<Document, Long> {
    ...
    List<Document> findByDocTypeAndContract_Status(Document.DocumentType docType,
            Contract.ContractStatus status);

    List<Document> findByContract_Id(Long contractId);

    List<Document> findByContract_IdAndDocType(Long contractId, Document.DocumentType docType);
}
